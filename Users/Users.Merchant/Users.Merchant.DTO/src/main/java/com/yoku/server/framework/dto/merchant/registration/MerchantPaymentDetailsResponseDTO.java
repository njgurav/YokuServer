...
public class MerchantPaymentDetailsResponseDTO extends BaseResponseDTO {

	/**
	 * Serial Version UID.
	 */
	private static final long serialVersionUID = 1478961470084427773L;
	/**
	 * Company Pan number
	 */
